    ...
    return (
        <Grid item xs={12} sm={12} md={12} lg={12} className="vehicleAdvantageSec">
            <div className="vehicleAdvantage">
                ...
                <div className="center-align"><img src={headingLines} alt=""/></div><br/><br/>
                    <div className="advantageSec">
                        <Grid container component="div" direction="row" className="advantage">
                            <Grid item xs={2} md={2} lg={2}>
                                <div className="advantageIconLeft"><img className="rupees" src={certifiedIcon} alt=""/></div>
                            </Grid>
                        ...
                        <Grid container component="div" direction="row" className="advantage1">
                            ...
                            <Grid item xs={2} sm={2} md={2} lg={2} className="icon">
                                <div className="advantageIconRight"><img className="rupees" src={warrantyIcon} alt=""/></div>
                            </Grid>
                        </Grid>
                        <Grid container component="div" direction="row" className="advantage">
                            <Grid item xs={2} sm={2} md={2} lg={2}>
                                <div className="advantageIconLeft"><img className="rupees" src={buyerIcon} alt=""/></div>
                            </Grid>
                            <Grid item xs={10} sm={10} md={10} lg={10}>
                        ...
                        <Grid container component="div" direction="row" className="advantage1">
                            ...
                            <Grid item xs={2} sm={2} md={2} lg={2} className="icon">
                                <div className="advantageIconRight"><img className="rupees" src={emiIcon} alt=""/></div>
                            </Grid>
                        </Grid>
                        <Grid container component="div" direction="row" className="advantage">
                            <Grid item xs={2} sm={2} md={2} lg={2}>
                                <div className="advantageIconLeft"><img className="rupees" src={transferIcon} alt=""/></div>
                            </Grid>
                            <Grid item xs={10} sm={10} md={10} lg={10}>
