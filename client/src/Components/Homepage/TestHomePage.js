  ...
  return (
    <div className="App">
        ...
        <ul className="slides">
          <li>
            ...
            <div className="caption left-align">
              ...
              {/* <div className="test-carousel-search-container">
                <div className="test-carousel-location-btn">
                  <img alt="" src={locationIcon} width="23" height="20" />
                  <div className="test-loc-text">Aluva</div>
                </div>
                <div className="test-carousel-search-box">
                  <input
                    type="text"
                ...
                <Link to={`/category/bike?searchTerm=${searchTerm}`}>
                  <button className="test-carousel-search-label" type="button">
      ...
      <div className="test-section-2">
        <Grid container component="div" direction="row" className="test-row">
          <Grid
            item
            xs={12}
            md={12}
            sm={12}
            lg={12}
            className="center-align test-section-2-heading"
          >
        ...
        <Grid container component="div" direction="row">
          <Grid item xs={12} sm={12} md={4} lg={4} className="test-flex-center">
            <div className="test-box-shadow center-align">
      ...
      <div className="test-section-3">
        <Grid container component="div" direction="row" className="test-advantageRow">
          <Grid
            item
            xs={12}
            sm={12}
            md={12}
            lg={12}
            className="center-align test-section-3-heading"
          >
            <h3>BIKEBAZAAR ADVANTAGE</h3>
            <img alt="" src={headingLines} width="57" height="4" />
          </Grid>
        </Grid>
        <Grid container component="div" direction="row" className="test-row test-padHorizontal5">
          <Grid item xs={12} sm={12} md={4} lg={4}>
            <div className="test-gola-wrapper">
              <div className="test-gola valign-wrapper">
                <img alt="" src={certifiedAutoExperts} height="69" width="69" />
              </div>
            </div>
            <div className="center-align">
              <h5>Certified by Auto Experts</h5>
              <p className="test-advantage-subtitle-1">
        ...
        >
          <Grid item xs={12} sm={12} md={4} lg={5}>
            <div className="test-gola-wrapper">
              <div className="test-gola-2 valign-wrapper">
                <img alt="" src={lowCostEmi} height="69" width="69" />
              </div>
            </div>
            <div className="center-align">
              <h5>Low Cost EMI</h5>
              <p className="test-advantage-subtitle">
          ...
          <Grid item xs={12} sm={12} md={4} lg={4}>
            ...
            <div className="center-align test-hfdc">
      ...
      {/* <div className="test-section-4">
        <Grid
          container
          component="div"
          direction="row"
          className="test-row center-align"
        >
        ...
        <Grid container component="div" direction="row" className="test-row mb-0">
          <Grid item xs={1} sm={1} md={1} lg={1}>
            <div className="valign-wrapper arrow-container">
              <button
                className="test-btn-floating btn-large waves-effect waves-light white"
                id="slideLeft"
                onClick={() => initCar("left")}
              >
                <i className="test-material-icons icon-black">keyboard_arrow_left</i>
                initCar
              </button>
            </div>
          </Grid>
          <Grid item xs={10} sm={10} md={10} lg={10} className="center-align">
            <div className="test-carousel">
              <a className="test-carousel-item" href="#one!" index="0">
                <img alt="" className="test-circle" src={testimonial1} />
              </a>
              <a className="test-carousel-item" href="#two!" index="1">
                <img alt="" className="test-circle" src={testimonial2} />
              </a>
              <a className="test-carousel-item" href="#three!" index="2">
                <img alt="" className="test-circle" src={testimonial3} />
              </a>
              <a className="test-carousel-item" href="#four!" index="3">
                <img alt="" className="test-circle" src={testimonial4} />
              </a>
              <a className="test-carousel-item" href="#five!" index="4">
                <img alt="" className="test-circle" src={testimonial5} />
              </a>
            </div>
          </Grid>
          <Grid item xs={1} sm={1} md={1} lg={1}>
            <div className="valign-wrapper arrow-container">
              ...
              >
                <i className="test-material-icons icon-black">
